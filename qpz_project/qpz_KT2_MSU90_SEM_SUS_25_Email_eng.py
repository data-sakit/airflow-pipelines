...
to_emails_KT2= ['e.martynov@titan2.ru','m.anufrienok@titan2.ru','a.kirilenko@titan2.ru','i.ivanova@titan2.ru','t.bobylev@titan2.ru','o.akimenko@titan2.ru','e.mezhiritskaya@titan2.ru','t.speranskaya@titan2.ru','i.elnikova@titan2.ru','s.mamedov@titan2.ru']
to_emails_KT2_ДПО= ['aa.samsonov@titan2.ru','yu.miroshnichenko@titan2.ru','e.mezhiritskaya@titan2.ru','t.speranskaya@titan2.ru','i.elnikova@titan2.ru','s.mamedov@titan2.ru']
to_emails_MS90= ['d.strokin@titan2.ru','a.vologdin@titan2.ru','e.mezhiritskaya@titan2.ru','t.speranskaya@titan2.ru','i.elnikova@titan2.ru','s.mamedov@titan2.ru']
to_emails_AOSEM= ['a.morozova@titan2.ru','vg.komarov@titan2.ru','v.balitskiy@titan2.ru','e.mezhiritskaya@titan2.ru','t.speranskaya@titan2.ru','i.elnikova@titan2.ru','s.mamedov@titan2.ru']
to_emails_PAOSUS= ['e.martynov@titan2.ru','ns.pavlova@titan2.ru','an.belov@titan2.ru','t.bobylev@titan2.ru','o.akimenko@titan2.ru','e.mezhiritskaya@titan2.ru','t.speranskaya@titan2.ru','i.elnikova@titan2.ru','s.mamedov@titan2.ru']
...
group_KT2_другие=['Дирекция Прорыв', 'Дирекция по строительству','ДРНАП']
group_KT2_ДПО=['ДПО']
group_MS90=['МСУ-90']
group_AOSEM=['АО СЭМ']
group_PAOSUS=['ПАО СУС']


with DAG('QPZ_KT2_MSU90_SEM_SUS_25', default_args=default_args, schedule='0 6 * * 3') as dag:
    ...
    d_25 = fetch_data_25()
    @task(task_id="vis1__KT2")
    def vis1__KT2(data_25):
        data_25 = data_25[data_25['Группа'].isin(group_KT2_другие)]
        ...
        vis_1__KT2 = base64.b64encode(buffer.getvalue()).decode('utf-8')
        return vis_1__KT2

    @task(task_id="vis2__KT2")
    def vis2__KT2(data_25):
        data_25 = data_25[data_25['Группа'].isin(group_KT2_другие)]
        ...
        buffer.seek(0)
        plt.close()
        vis_2__KT2 = base64.b64encode(buffer.getvalue()).decode('utf-8')
        return vis_2__KT2

    @task(task_id="vis3__KT2")
    def vis3__KT2(data_25):
        data_25 = data_25[data_25['Группа'].isin(group_KT2_другие)]
        ...
        buffer.seek(0)
        plt.close()
        vis_3__KT2= base64.b64encode(buffer.getvalue()).decode('utf-8')
        return vis_3__KT2

    @task(task_id="vis4__KT2")
    def vis4__KT2(data_25):
        data_25 = data_25[data_25['Группа'].isin(group_KT2_другие)]
        df_sum=data_25[['month_name','month_order','e_c','p_c','f_c_v_plan','f_c_vne_plan']].groupby(['month_name','month_order']).sum().reset_index()
        df_sum = df_sum.sort_values('month_order')
        ...
        buffer.seek(0)
        plt.close()
        vis_4__KT2= base64.b64encode(buffer.getvalue()).decode('utf-8')
        return vis_4__KT2

    @task(task_id="vis5__KT2")
    def vis5__KT2(data_25):
        data_25 = data_25[data_25['Группа'].isin(group_KT2_другие)]
        ...
        buffer.seek(0)
        plt.close()
        vis_5__KT2= base64.b64encode(buffer.getvalue()).decode('utf-8')
        return vis_5__KT2

    @task(task_id="vis6__KT2")
    def vis6__KT2(data_25):
        data_25 = data_25[data_25['Группа'].isin(group_KT2_другие)]
        ...
        buffer.seek(0)
        plt.close()
        vis_6__KT2= base64.b64encode(buffer.getvalue()).decode('utf-8')
        return vis_6__KT2

    @task(task_id="vis7__KT2")
    def vis7__KT2(data_25):
        data_25 = data_25[data_25['Группа'].isin(group_KT2_другие)]
        ...
        buffer.seek(0)
        plt.close()
        vis_7__KT2= base64.b64encode(buffer.getvalue()).decode('utf-8')
        return vis_7__KT2

    @task(task_id="vis8__KT2")
    def vis8__KT2(data_25):
        data_25 = data_25[data_25['Группа'].isin(group_KT2_другие)]
        df_table=data_25[['s','e_q', 'e_c','p_q', 'p_c','f_c_v_plan','f_q_v_plan']].groupby(['s']).sum().reset_index()
        df_table = df_table.round(2)
        df_table = df_table.applymap(lambda x: f"{x:,.0f}".replace(",", " ") if isinstance(x, (int, float)) else x)
        ...
        buffer.seek(0)
        plt.close()
        vis_8__KT2 = base64.b64encode(buffer.getvalue()).decode('utf-8')
        return vis_8__KT2

    @task(task_id="send_email_KT2")
    def send_email_KT2(vis_1__KT2, vis_2__KT2,vis_3__KT2,vis_4__KT2,vis_5__KT2,vis_6__KT2,vis_7__KT2,vis_8__KT2):
        def decode_base64_to_image(base64_string):
            image_data = base64.b64decode(base64_string)
            return Image.open(io.BytesIO(image_data))

        img1 = decode_base64_to_image(vis_1__KT2)
        img2 = decode_base64_to_image(vis_2__KT2)
        img3 = decode_base64_to_image(vis_3__KT2)
        img4 = decode_base64_to_image(vis_4__KT2)
        img5 = decode_base64_to_image(vis_5__KT2)
        img6 = decode_base64_to_image(vis_6__KT2)
        img7 = decode_base64_to_image(vis_7__KT2)
        img8 = decode_base64_to_image(vis_8__KT2)
        ...
        pdf_filename = "/opt/airflow/dags/QPZ_ETL_Image/КТ_2.pdf"  # Укажите нужный путь
        cover = "/opt/airflow/dags/QPZ_ETL_Image/KT2.jpg"

        cover_imge = Image.open(cover)

        cover_imge = add_white_background(cover_imge)

        cover_imge.save(pdf_filename, format="PDF", resolution=300.0, save_all=True, append_images=[img1,img2,img3,img4,img5,img6,img7,img8])

        html_content = f"""
        <html>
            <body>
                <img src="data:image/png;base64,{vis_1__KT2}" alt="График1">
                <img src="data:image/png;base64,{vis_2__KT2}" alt="График2">
            </body>
        </html>
        """
        ...
        email_task = EmailOperator(
            ...
            to=to_emails_KT2,
            subject='ГПЗ АО “КОНЦЕРН ТИТАН-2',
            html_content=html_content,
            files=[pdf_filename]  # Передаем только путь к файлу
        )
        email_task.execute(context={})

    vis_1__KT2 = vis1__KT2(d_25)
    vis_2__KT2 = vis2__KT2(d_25)
    vis_3__KT2 = vis3__KT2(d_25)
    vis_4__KT2 = vis4__KT2(d_25)
    vis_5__KT2 = vis5__KT2(d_25)
    vis_6__KT2 = vis6__KT2(d_25)
    vis_7__KT2 = vis7__KT2(d_25)
    vis_8__KT2 = vis8__KT2(d_25)

    send_email_KT2(vis_1__KT2, vis_2__KT2,vis_3__KT2,vis_4__KT2,vis_5__KT2,vis_6__KT2, vis_7__KT2,vis_8__KT2)


    @task(task_id="vis1__KT2_DPO")
    def vis1__KT2_DPO(data_25):
        data_25 = data_25[data_25['Группа'].isin(group_KT2_ДПО)]
        grouped_data = data_25[['month_order','month_name', 'e_c', 'p_c', 'f_c_vne_plan','f_c_v_plan']].groupby(['month_order','month_name']).sum().reset_index()
        grouped_data = grouped_data.sort_values('month_order')
        ...
        vis_1__KT2_DPO = base64.b64encode(buffer.getvalue()).decode('utf-8')
        return vis_1__KT2_DPO

    @task(task_id="vis2__KT2_DPO")
    def vis2__KT2_DPO(data_25):
        data_25 = data_25[data_25['Группа'].isin(group_KT2_ДПО)]
        ...
        buffer.seek(0)
        plt.close()
        vis_2__KT2_DPO = base64.b64encode(buffer.getvalue()).decode('utf-8')
        return vis_2__KT2_DPO

    @task(task_id="vis3__KT2_DPO")
    def vis3__KT2_DPO(data_25):
        data_25 = data_25[data_25['Группа'].isin(group_KT2_ДПО)]
        df_sum=data_25[['month_name','month_order','e_c','p_c','f_c_v_plan','f_c_vne_plan']].groupby(['month_name','month_order']).sum().reset_index()
        df_sum = df_sum.sort_values('month_order')
        df_sum['Cumulative_e_c'] = df_sum['e_c'].cumsum()
        ...
        buffer.seek(0)
        plt.close()
        vis_3__KT2_DPO= base64.b64encode(buffer.getvalue()).decode('utf-8')
        return vis_3__KT2_DPO

    @task(task_id="vis4__KT2_DPO")
    def vis4__KT2_DPO(data_25):
        data_25 = data_25[data_25['Группа'].isin(group_KT2_ДПО)]
        df_sum=data_25[['month_name','month_order','e_c','p_c','f_c_v_plan','f_c_vne_plan']].groupby(['month_name','month_order']).sum().reset_index()
        df_sum = df_sum.sort_values('month_order')
        ...
        buffer.seek(0)
        plt.close()
        vis_4__KT2_DPO= base64.b64encode(buffer.getvalue()).decode('utf-8')
        return vis_4__KT2_DPO

    @task(task_id="vis5__KT2_DPO")
    def vis5__KT2_DPO(data_25):
        data_25 = data_25[data_25['Группа'].isin(group_KT2_ДПО)]
        df_enl=data_25[['s','e_c','p_c','f_c_v_plan','f_c_vne_plan']].groupby(['s']).sum().reset_index()
        df_enl_10 = df_enl.sort_values(by='e_c', ascending=False).head(10).sort_values('e_c',ascending=False)
        df_enl_10['s']=df_enl_10['s'].apply(lambda x: x.replace(' ','\n'))
        ...
        buffer.seek(0)
        plt.close()
        vis_5__KT2_DPO= base64.b64encode(buffer.getvalue()).decode('utf-8')
        return vis_5__KT2_DPO

    @task(task_id="vis6__KT2_DPO")
    def vis6__KT2_DPO(data_25):
        data_25 = data_25[data_25['Группа'].isin(group_KT2_ДПО)]
        df_enl=data_25[['s','e_q', 'e_c','p_q','f_q_v_plan','f_q_vne_plan']].groupby(['s']).sum().reset_index()
        df_enl_10 = df_enl.sort_values(by='e_c', ascending=False).head(10).sort_values('e_c',ascending=False)
        df_enl_10['s']=df_enl_10['s'].apply(lambda x: x.replace(' ','\n'))
        ...
        buffer.seek(0)
        plt.close()
        vis_6__KT2_DPO= base64.b64encode(buffer.getvalue()).decode('utf-8')
        return vis_6__KT2_DPO

    @task(task_id="vis7__KT2_DPO")
    def vis7__KT2_DPO(data_25):
        data_25 = data_25[data_25['Группа'].isin(group_KT2_ДПО)]
        df_table=data_25[['s','e_q', 'e_c','p_q', 'p_c','f_c_v_plan','f_q_v_plan']].groupby(['s']).sum().reset_index()
        ...
        buffer.seek(0)
        plt.close()
        vis_7__KT2_DPO= base64.b64encode(buffer.getvalue()).decode('utf-8')
        return vis_7__KT2_DPO

    @task(task_id="vis8__KT2_DPO")
    def vis8__KT2_DPO(data_25):
        data_25 = data_25[data_25['Группа'].isin(group_KT2_ДПО)]
        df_table=data_25[['s','e_q', 'e_c','p_q', 'p_c','f_c_v_plan','f_q_v_plan']].groupby(['s']).sum().reset_index()
        df_table = df_table.round(2)
        df_table = df_table.applymap(lambda x: f"{x:,.0f}".replace(",", " ") if isinstance(x, (int, float)) else x)
        ...
        buffer.seek(0)
        plt.close()
        vis_8__KT2_DPO = base64.b64encode(buffer.getvalue()).decode('utf-8')
        return vis_8__KT2_DPO

    @task(task_id="send_email_KT2")
    def send_email__KT2_DPO(vis_1__KT2_DPO, vis_2__KT2_DPO,vis_3__KT2_DPO,vis_4__KT2_DPO,vis_5__KT2_DPO,vis_6__KT2_DPO,vis_7__KT2_DPO,vis_8__KT2_DPO):
        def decode_base64_to_image(base64_string):
            image_data = base64.b64decode(base64_string)
            return Image.open(io.BytesIO(image_data))

        img1 = decode_base64_to_image(vis_1__KT2_DPO)
        img2 = decode_base64_to_image(vis_2__KT2_DPO)
        img3 = decode_base64_to_image(vis_3__KT2_DPO)
        img4 = decode_base64_to_image(vis_4__KT2_DPO)
        img5 = decode_base64_to_image(vis_5__KT2_DPO)
        img6 = decode_base64_to_image(vis_6__KT2_DPO)
        img7 = decode_base64_to_image(vis_7__KT2_DPO)
        img8 = decode_base64_to_image(vis_8__KT2_DPO)
        ...
        img7 = add_white_background(img7)
        img8 = add_white_background(img8)
        pdf_filename = "/opt/airflow/dags/QPZ_ETL_Image/КТ_2_ДПО.pdf"  # Укажите нужный путь
        cover = "/opt/airflow/dags/QPZ_ETL_Image/KT2.jpg"
        ...
        <html>
            <body>
                <img src="data:image/png;base64,{vis_1__KT2_DPO}" alt="График1">
                <img src="data:image/png;base64,{vis_2__KT2_DPO}" alt="График2">
            </body>
        </html>
        """
        ...
        email_task = EmailOperator(
            task_id='send_email_task',
            to=to_emails_KT2_ДПО,
            subject='ГПЗ АО "КОНЦЕРН ТИТАН-2"-ДПО',
            html_content=html_content,
            files=[pdf_filename]  # Передаем только путь к файлу
        )
        email_task.execute(context={})

    vis_1__KT2_DPO = vis1__KT2_DPO(d_25)
    vis_2__KT2_DPO = vis2__KT2_DPO(d_25)
    vis_3__KT2_DPO = vis3__KT2_DPO(d_25)
    vis_4__KT2_DPO = vis4__KT2_DPO(d_25)
    vis_5__KT2_DPO = vis5__KT2_DPO(d_25)
    vis_6__KT2_DPO = vis6__KT2_DPO(d_25)
    vis_7__KT2_DPO = vis7__KT2_DPO(d_25)
    vis_8__KT2_DPO = vis8__KT2_DPO(d_25)

    send_email__KT2_DPO(vis_1__KT2_DPO, vis_2__KT2_DPO,vis_3__KT2_DPO,vis_4__KT2_DPO,vis_5__KT2_DPO,vis_6__KT2_DPO, vis_7__KT2_DPO,vis_8__KT2_DPO)


    @task(task_id="vis1_MS90")
    def vis1_MS90(data_25):
        data_25 = data_25[data_25['Группа'].isin(group_MS90)]
        grouped_data = data_25[['month_order','month_name', 'e_c', 'p_c', 'f_c_vne_plan','f_c_v_plan']].groupby(['month_order','month_name']).sum().reset_index()
        grouped_data = grouped_data.sort_values('month_order')
        ...
        vis_1_MS90 = base64.b64encode(buffer.getvalue()).decode('utf-8')
        return vis_1_MS90

    @task(task_id="vis2_MS90")
    def vis2_MS90(data_25):
        data_25 = data_25[data_25['Группа'].isin(group_MS90)]
        ...
        buffer.seek(0)
        plt.close()
        vis_2_MS90 = base64.b64encode(buffer.getvalue()).decode('utf-8')
        return vis_2_MS90

    @task(task_id="vis3_MS90")
    def vis3_MS90(data_25):
        data_25 = data_25[data_25['Группа'].isin(group_MS90)]
        df_sum=data_25[['month_name','month_order','e_c','p_c','f_c_v_plan','f_c_vne_plan']].groupby(['month_name','month_order']).sum().reset_index()
        df_sum = df_sum.sort_values('month_order')
        df_sum['Cumulative_e_c'] = df_sum['e_c'].cumsum()
        ...
        buffer.seek(0)
        plt.close()
        vis_3_MS90= base64.b64encode(buffer.getvalue()).decode('utf-8')
        return vis_3_MS90

    @task(task_id="vis4_MS90")
    def vis4_MS90(data_25):
        data_25 = data_25[data_25['Группа'].isin(group_MS90)]
        df_sum=data_25[['month_name','month_order','e_c','p_c','f_c_v_plan','f_c_vne_plan']].groupby(['month_name','month_order']).sum().reset_index()
        df_sum = df_sum.sort_values('month_order')
        ...
        buffer.seek(0)
        plt.close()
        vis_4_MS90= base64.b64encode(buffer.getvalue()).decode('utf-8')
        return vis_4_MS90

    @task(task_id="vis5_MS90")
    def vis5_MS90(data_25):
        data_25 = data_25[data_25['Группа'].isin(group_MS90)]
        df_enl=data_25[['s','e_c','p_c','f_c_v_plan','f_c_vne_plan']].groupby(['s']).sum().reset_index()
        df_enl_10 = df_enl.sort_values(by='e_c', ascending=False).head(10).sort_values('e_c',ascending=False)
        df_enl_10['s']=df_enl_10['s'].apply(lambda x: x.replace(' ','\n'))
        ...
        buffer.seek(0)
        plt.close()
        vis_5_MS90= base64.b64encode(buffer.getvalue()).decode('utf-8')
        return vis_5_MS90

    @task(task_id="vis6_MS90")
    def vis6_MS90(data_25):
        data_25 = data_25[data_25['Группа'].isin(group_MS90)]
        df_enl=data_25[['s','e_q', 'e_c','p_q','f_q_v_plan','f_q_vne_plan']].groupby(['s']).sum().reset_index()
        df_enl_10 = df_enl.sort_values(by='e_c', ascending=False).head(10).sort_values('e_c',ascending=False)
        df_enl_10['s']=df_enl_10['s'].apply(lambda x: x.replace(' ','\n'))
        ...
        buffer.seek(0)
        plt.close()
        vis_6_MS90= base64.b64encode(buffer.getvalue()).decode('utf-8')
        return vis_6_MS90

    @task(task_id="vis7_MS90")
    def vis7_MS90(data_25):
        data_25 = data_25[data_25['Группа'].isin(group_MS90)]
        df_table=data_25[['s','e_q', 'e_c','p_q', 'p_c','f_c_v_plan','f_q_v_plan']].groupby(['s']).sum().reset_index()
        ...
        buffer.seek(0)
        plt.close()
        vis_7_MS90= base64.b64encode(buffer.getvalue()).decode('utf-8')
        return vis_7_MS90

    @task(task_id="vis8_MS90")
    def vis8_MS90(data_25):
        data_25 = data_25[data_25['Группа'].isin(group_MS90)]
        df_table=data_25[['s','e_q', 'e_c','p_q', 'p_c','f_c_v_plan','f_q_v_plan']].groupby(['s']).sum().reset_index()
        df_table = df_table.round(2)
        df_table = df_table.applymap(lambda x: f"{x:,.0f}".replace(",", " ") if isinstance(x, (int, float)) else x)
        ...
        buffer.seek(0)
        plt.close()
        vis_8_MS90 = base64.b64encode(buffer.getvalue()).decode('utf-8')
        return vis_8_MS90

    @task(task_id="send_email_MS90")
    def send_email_MS90(vis_1_MS90, vis_2_MS90,vis_3_MS90,vis_4_MS90,vis_5_MS90,vis_6_MS90,vis_7_MS90,vis_8_MS90):
        def decode_base64_to_image(base64_string):
            image_data = base64.b64decode(base64_string)
            return Image.open(io.BytesIO(image_data))

        img1 = decode_base64_to_image(vis_1_MS90)
        img2 = decode_base64_to_image(vis_2_MS90)
        img3 = decode_base64_to_image(vis_3_MS90)
        img4 = decode_base64_to_image(vis_4_MS90)
        img5 = decode_base64_to_image(vis_5_MS90)
        img6 = decode_base64_to_image(vis_6_MS90)
        img7 = decode_base64_to_image(vis_7_MS90)
        img8 = decode_base64_to_image(vis_8_MS90)
        ...
        pdf_filename = "/opt/airflow/dags/QPZ_ETL_Image/МСУ_90.pdf"  # Укажите нужный путь

        cover = "/opt/airflow/dags/QPZ_ETL_Image/MSU.jpg"
        ...
        <html>
            <body>
                <img src="data:image/png;base64,{vis_1_MS90}" alt="График1">
                <img src="data:image/png;base64,{vis_2_MS90}" alt="График2">
            </body>
        </html>
        """
    ...
    vis_1_MS90 = vis1_MS90(d_25)
    vis_2_MS90 = vis2_MS90(d_25)
    vis_3_MS90 = vis3_MS90(d_25)
    vis_4_MS90 = vis4_MS90(d_25)
    vis_5_MS90 = vis5_MS90(d_25)
    vis_6_MS90 = vis6_MS90(d_25)
    vis_7_MS90 = vis7_MS90(d_25)
    vis_8_MS90 = vis8_MS90(d_25)

    send_email_MS90(vis_1_MS90, vis_2_MS90,vis_3_MS90,vis_4_MS90,vis_5_MS90,vis_6_MS90, vis_7_MS90,vis_8_MS90)


    @task(task_id="vis1_AOSEM")
    def vis1_AOSEM(data_25):
        data_25 = data_25[data_25['Группа'].isin(group_AOSEM)]
        grouped_data = data_25[['month_order','month_name', 'e_c', 'p_c', 'f_c_vne_plan','f_c_v_plan']].groupby(['month_order','month_name']).sum().reset_index()
        grouped_data = grouped_data.sort_values('month_order')
        ...
        vis_1_AOSEM= base64.b64encode(buffer.getvalue()).decode('utf-8')
        return vis_1_AOSEM

    @task(task_id="vis2_AOSEM")
    def vis2_AOSEM(data_25):
        data_25 = data_25[data_25['Группа'].isin(group_AOSEM)]
        ...
        buffer.seek(0)
        plt.close()
        vis_2_AOSEM= base64.b64encode(buffer.getvalue()).decode('utf-8')
        return vis_2_AOSEM

    @task(task_id="vis3_AOSEM")
    def vis3_AOSEM(data_25):
        data_25 = data_25[data_25['Группа'].isin(group_AOSEM)]
        df_sum=data_25[['month_name','month_order','e_c','p_c','f_c_v_plan','f_c_vne_plan']].groupby(['month_name','month_order']).sum().reset_index()
        df_sum = df_sum.sort_values('month_order')
        df_sum['Cumulative_e_c'] = df_sum['e_c'].cumsum()
        ...
        buffer.seek(0)
        plt.close()
        vis_3_AOSEM= base64.b64encode(buffer.getvalue()).decode('utf-8')
        return vis_3_AOSEM

    @task(task_id="vis4_AOSEM")
    def vis4_AOSEM(data_25):
        data_25 = data_25[data_25['Группа'].isin(group_AOSEM)]
        df_sum=data_25[['month_name','month_order','e_c','p_c','f_c_v_plan','f_c_vne_plan']].groupby(['month_name','month_order']).sum().reset_index()
        df_sum = df_sum.sort_values('month_order')
        ...
        buffer.seek(0)
        plt.close()
        vis_4_AOSEM= base64.b64encode(buffer.getvalue()).decode('utf-8')
        return vis_4_AOSEM

    @task(task_id="vis5_AOSEM")
    def vis5_AOSEM(data_25):
        data_25 = data_25[data_25['Группа'].isin(group_AOSEM)]
        df_enl=data_25[['s','e_c','p_c','f_c_v_plan','f_c_vne_plan']].groupby(['s']).sum().reset_index()
        df_enl_10 = df_enl.sort_values(by='e_c', ascending=False).head(10).sort_values('e_c',ascending=False)
        df_enl_10['s']=df_enl_10['s'].apply(lambda x: x.replace(' ','\n'))
        ...
        buffer.seek(0)
        plt.close()
        vis_5_AOSEM= base64.b64encode(buffer.getvalue()).decode('utf-8')
        return vis_5_AOSEM

    @task(task_id="vis6_AOSEM")
    def vis6_AOSEM(data_25):
        data_25 = data_25[data_25['Группа'].isin(group_AOSEM)]
        df_enl=data_25[['s','e_q', 'e_c','p_q','f_q_v_plan','f_q_vne_plan']].groupby(['s']).sum().reset_index()
        df_enl_10 = df_enl.sort_values(by='e_c', ascending=False).head(10).sort_values('e_c',ascending=False)
        df_enl_10['s']=df_enl_10['s'].apply(lambda x: x.replace(' ','\n'))
        ...
        buffer.seek(0)
        plt.close()
        vis_6_AOSEM= base64.b64encode(buffer.getvalue()).decode('utf-8')
        return vis_6_AOSEM

    @task(task_id="vis7_AOSEM")
    def vis7_AOSEM(data_25):
        data_25 = data_25[data_25['Группа'].isin(group_AOSEM)]
        df_table=data_25[['s','e_q', 'e_c','p_q', 'p_c','f_c_v_plan','f_q_v_plan']].groupby(['s']).sum().reset_index()
        ...
        buffer.seek(0)
        plt.close()
        vis_7_AOSEM= base64.b64encode(buffer.getvalue()).decode('utf-8')
        return vis_7_AOSEM

    @task(task_id="vis8_AOSEM")
    def vis8_AOSEM(data_25):
        data_25 = data_25[data_25['Группа'].isin(group_AOSEM)]
        df_table=data_25[['s','e_q', 'e_c','p_q', 'p_c','f_c_v_plan','f_q_v_plan']].groupby(['s']).sum().reset_index()
        df_table = df_table.round(2)
        df_table = df_table.applymap(lambda x: f"{x:,.0f}".replace(",", " ") if isinstance(x, (int, float)) else x)
        ...
        buffer.seek(0)
        plt.close()
        vis_8_AOSEM= base64.b64encode(buffer.getvalue()).decode('utf-8')
        return vis_8_AOSEM

    @task(task_id="send_email_AOSEM")
    def send_email_AOSEM(vis_1_AOSEM, vis_2_AOSEM,vis_3_AOSEM,vis_4_AOSEM,vis_5_AOSEM,vis_6_AOSEM,vis_7_AOSEM,vis_8_AOSEM):
        def decode_base64_to_image(base64_string):
            image_data = base64.b64decode(base64_string)
            return Image.open(io.BytesIO(image_data))

        img1 = decode_base64_to_image(vis_1_AOSEM)
        img2 = decode_base64_to_image(vis_2_AOSEM)
        img3 = decode_base64_to_image(vis_3_AOSEM)
        img4 = decode_base64_to_image(vis_4_AOSEM)
        img5 = decode_base64_to_image(vis_5_AOSEM)
        img6 = decode_base64_to_image(vis_6_AOSEM)
        img7 = decode_base64_to_image(vis_7_AOSEM)
        img8 = decode_base64_to_image(vis_8_AOSEM)
        ...
        img7 = add_white_background(img7)
        img8 = add_white_background(img8)
        pdf_filename = "/opt/airflow/dags/QPZ_ETL_Image/АО_СЭМ.pdf"  # Укажите нужный путь
        
        cover = "/opt/airflow/dags/QPZ_ETL_Image/SEM.jpg"
        ...
        <html>
            <body>
                <img src="data:image/png;base64,{vis_1_AOSEM}" alt="График1">
                <img src="data:image/png;base64,{vis_2_AOSEM}" alt="График2">
            </body>
        </html>
        """
    ...
    vis_1_AOSEM= vis1_AOSEM(d_25)
    vis_2_AOSEM= vis2_AOSEM(d_25)
    vis_3_AOSEM= vis3_AOSEM(d_25)
    vis_4_AOSEM= vis4_AOSEM(d_25)
    vis_5_AOSEM= vis5_AOSEM(d_25)
    vis_6_AOSEM= vis6_AOSEM(d_25)
    vis_7_AOSEM= vis7_AOSEM(d_25)
    vis_8_AOSEM= vis8_AOSEM(d_25)

    send_email_AOSEM(vis_1_AOSEM, vis_2_AOSEM,vis_3_AOSEM,vis_4_AOSEM,vis_5_AOSEM,vis_6_AOSEM, vis_7_AOSEM,vis_8_AOSEM)


    @task(task_id="vis1_PAOSUS")
    def vis1_PAOSUS(data_25):
        data_25 = data_25[data_25['Группа'].isin(group_PAOSUS)]
        grouped_data = data_25[['month_order','month_name', 'e_c', 'p_c', 'f_c_vne_plan','f_c_v_plan']].groupby(['month_order','month_name']).sum().reset_index()
        grouped_data = grouped_data.sort_values('month_order')
        ...
        vis_1_PAOSUS= base64.b64encode(buffer.getvalue()).decode('utf-8')
        return vis_1_PAOSUS

    @task(task_id="vis2_PAOSUS")
    def vis2_PAOSUS(data_25):
        data_25 = data_25[data_25['Группа'].isin(group_PAOSUS)]
        ...
        buffer.seek(0)
        plt.close()
        vis_2_PAOSUS= base64.b64encode(buffer.getvalue()).decode('utf-8')
        return vis_2_PAOSUS

    @task(task_id="vis3_PAOSUS")
    def vis3_PAOSUS(data_25):
        data_25 = data_25[data_25['Группа'].isin(group_PAOSUS)]
        df_sum=data_25[['month_name','month_order','e_c','p_c','f_c_v_plan','f_c_vne_plan']].groupby(['month_name','month_order']).sum().reset_index()
        df_sum = df_sum.sort_values('month_order')
        df_sum['Cumulative_e_c'] = df_sum['e_c'].cumsum()
        ...
        buffer.seek(0)
        plt.close()
        vis_3_PAOSUS= base64.b64encode(buffer.getvalue()).decode('utf-8')
        return vis_3_PAOSUS

    @task(task_id="vis4_PAOSUS")
    def vis4_PAOSUS(data_25):
        data_25 = data_25[data_25['Группа'].isin(group_PAOSUS)]
        df_sum=data_25[['month_name','month_order','e_c','p_c','f_c_v_plan','f_c_vne_plan']].groupby(['month_name','month_order']).sum().reset_index()
        df_sum = df_sum.sort_values('month_order')
        ...
        buffer.seek(0)
        plt.close()
        vis_4_PAOSUS= base64.b64encode(buffer.getvalue()).decode('utf-8')
        return vis_4_PAOSUS

    @task(task_id="vis5_PAOSUS")
    def vis5_PAOSUS(data_25):
        data_25 = data_25[data_25['Группа'].isin(group_PAOSUS)]
        df_enl=data_25[['s','e_c','p_c','f_c_v_plan','f_c_vne_plan']].groupby(['s']).sum().reset_index()
        df_enl_10 = df_enl.sort_values(by='e_c', ascending=False).head(10).sort_values('e_c',ascending=False)
        df_enl_10['s']=df_enl_10['s'].apply(lambda x: x.replace(' ','\n'))
        ...
        buffer.seek(0)
        plt.close()
        vis_5_PAOSUS= base64.b64encode(buffer.getvalue()).decode('utf-8')
        return vis_5_PAOSUS

    @task(task_id="vis6_PAOSUS")
    def vis6_PAOSUS(data_25):
        data_25 = data_25[data_25['Группа'].isin(group_PAOSUS)]
        df_enl=data_25[['s','e_q', 'e_c','p_q','f_q_v_plan','f_q_vne_plan']].groupby(['s']).sum().reset_index()
        df_enl_10 = df_enl.sort_values(by='e_c', ascending=False).head(10).sort_values('e_c',ascending=False)
        df_enl_10['s']=df_enl_10['s'].apply(lambda x: x.replace(' ','\n'))
        ...
        buffer.seek(0)
        plt.close()
        vis_6_PAOSUS= base64.b64encode(buffer.getvalue()).decode('utf-8')
        return vis_6_PAOSUS

    @task(task_id="vis7_PAOSUS")
    def vis7_PAOSUS(data_25):
        data_25 = data_25[data_25['Группа'].isin(group_PAOSUS)]
        df_table=data_25[['s','e_q', 'e_c','p_q', 'p_c','f_c_v_plan','f_q_v_plan']].groupby(['s']).sum().reset_index()
        ...
        buffer.seek(0)
        plt.close()
        vis_7_PAOSUS= base64.b64encode(buffer.getvalue()).decode('utf-8')
        return vis_7_PAOSUS

    @task(task_id="vis8_PAOSUS")
    def vis8_PAOSUS(data_25):
        data_25 = data_25[data_25['Группа'].isin(group_PAOSUS)]
        df_table=data_25[['s','e_q', 'e_c','p_q', 'p_c','f_c_v_plan','f_q_v_plan']].groupby(['s']).sum().reset_index()
        df_table = df_table.round(2)
        df_table = df_table.applymap(lambda x: f"{x:,.0f}".replace(",", " ") if isinstance(x, (int, float)) else x)
        ...
        buffer.seek(0)
        plt.close()
        vis_8_PAOSUS= base64.b64encode(buffer.getvalue()).decode('utf-8')
        return vis_8_PAOSUS

    @task(task_id="send_email_PAOSUS")
    def send_email_PAOSUS(vis_1_PAOSUS, vis_2_PAOSUS,vis_3_PAOSUS,vis_4_PAOSUS,vis_5_PAOSUS,vis_6_PAOSUS,vis_7_PAOSUS,vis_8_PAOSUS):
        def decode_base64_to_image(base64_string):
            image_data = base64.b64decode(base64_string)
            return Image.open(io.BytesIO(image_data))

        img1 = decode_base64_to_image(vis_1_PAOSUS)
        img2 = decode_base64_to_image(vis_2_PAOSUS)
        img3 = decode_base64_to_image(vis_3_PAOSUS)
        img4 = decode_base64_to_image(vis_4_PAOSUS)
        img5 = decode_base64_to_image(vis_5_PAOSUS)
        img6 = decode_base64_to_image(vis_6_PAOSUS)
        img7 = decode_base64_to_image(vis_7_PAOSUS)
        img8 = decode_base64_to_image(vis_8_PAOSUS)
        ...
        img7 = add_white_background(img7)
        img8 = add_white_background(img8)
        pdf_filename = "/opt/airflow/dags/QPZ_ETL_Image/ПАО_СУС.pdf"  # Укажите нужный путь
        cover = "/opt/airflow/dags/QPZ_ETL_Image/SUS.jpg"
        ...
        <html>
            <body>
                <img src="data:image/png;base64,{vis_1_PAOSUS}" alt="График1">
                <img src="data:image/png;base64,{vis_2_PAOSUS}" alt="График2">
            </body>
        </html>
        """
    ...
    vis_1_PAOSUS= vis1_PAOSUS(d_25)
    vis_2_PAOSUS= vis2_PAOSUS(d_25)
    vis_3_PAOSUS= vis3_PAOSUS(d_25)
    vis_4_PAOSUS= vis4_PAOSUS(d_25)
    vis_5_PAOSUS= vis5_PAOSUS(d_25)
    vis_6_PAOSUS= vis6_PAOSUS(d_25)
    vis_7_PAOSUS= vis7_PAOSUS(d_25)
    vis_8_PAOSUS= vis8_PAOSUS(d_25)

    send_email_PAOSUS(vis_1_PAOSUS, vis_2_PAOSUS,vis_3_PAOSUS,vis_4_PAOSUS,vis_5_PAOSUS,vis_6_PAOSUS, vis_7_PAOSUS,vis_8_PAOSUS)